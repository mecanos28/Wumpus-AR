    ...
    public void onClick(View view) { //Funcion de los botones
        switch (view.getId())
        {
            ...
            case R.id.bcontinuar: {
                ...
                if (latitudElegida!=0.0 && longitudElegida!=0.0)
                {

                    //Crear las cuevas

                    putCave(numberCaves,latitudElegida,longitudElegida);

                    //Se las pasa al otro
                    i.putExtra("Latitud",latitudElegida);
                    i.putExtra("Longitud",longitudElegida);

                }
                else {//Crear las cuevas
                    putCave(numberCaves,latitud,longitud);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLngElegida) {
                ...
                latitudElegida=latLngElegida.latitude;
                longitudElegida=latLngElegida.longitude;
